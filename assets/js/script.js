/* ============================================================
   Ce fichier est chargé par toutes les pages du site.
   Chaque bloc vérifie que l'élément qu'il pilote existe avant de
   s'exécuter : les fiches projet, qui n'ont ni barre latérale ni
   grille de projets, peuvent donc utiliser le même script sans
